                    ...
                    <tr>
                        <td style="padding:30px; text-align:center;">
                            ...
                            <p style="color:#666;">
                                ...
                                Duration: 7 Days <br>
                                Expires At:
                                <b>{{ \Carbon\Carbon::parse($subscription->ends_at)->format('Y-m-d') }}</b>
                            </p>

                            <p style="color:#666; margin-top:20px;">
                                To unlock more features and grow your business, upgrade to a premium plan anytime.
                            </p>

                            <!-- CTA Button -->
                            <a href="https://yourdomain.com/pricing"
                               style="display:inline-block; margin-top:15px; padding:10px 20px; background:#2d89ef; color:#fff; text-decoration:none; border-radius:5px;">
                                Upgrade to Premium
                            </a>
