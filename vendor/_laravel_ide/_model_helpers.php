...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereBusinessLogo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereBusinessId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereBusinessCategory($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereBusinessAddress($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereCountry($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereCity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereTimeZone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereCurrency($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MerchantStoreSetting>|MerchantStoreSetting whereUpdatedAt($value)
     ...
     * @property-read \App\Models\Subscription $subscription
     * @property-read \App\Models\MerchantStoreSetting $storeSetting
