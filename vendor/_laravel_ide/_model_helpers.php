...
namespace App\Models {
     ...
     * @property-read \App\Models\User $user
     * @property-read \App\Models\User $merchant
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\MiniSite> $minisite
     * @property-read int|null $minisite_count
     ...
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string|null $background_color
     * @property string|null $feature_three_des
     * @property string|null $feature_three_title
     * @property string|null $feature_three_image
     * @property string|null $feature_two_des
     * @property string|null $feature_two_title
     * @property string|null $feature_two_image
     * @property string|null $feature_one_des
     * @property string|null $feature_one_title
     * @property string|null $feature_one_image
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\MiniSite> $minisite
     * @property-read int|null $minisite_count
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereSectionTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereSectionSubtitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereFeatureOneImage($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereFeatureOneTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereFeatureOneDes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereFeatureTwoImage($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereFeatureTwoTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereFeatureTwoDes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereFeatureThreeImage($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereFeatureThreeTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereFeatureThreeDes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereBackgroundColor($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<WhyChooseUs>|WhyChooseUs timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class WhyChooseUs extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
